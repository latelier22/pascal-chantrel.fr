...
const Navbar = () => {
  ...
  return (
    <>
    <nav
      className="z-40 md:fixed flex w-full items-center justify-between bg-sky-200 py-2 text-black shadow-lg hover:text-neutral-700 focus:text-neutral-700 dark:bg-black dark:text-gold-500 md:flex-wrap"
      data-te-navbar-ref
    >
